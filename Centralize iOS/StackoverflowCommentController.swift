//
//  StackoverflowCommentController.swift
//  Centralize iOS
//
//  Created by Loïc Juillet on 10/11/2016.
//  Copyright © 2016 Centralize. All rights reserved.
//

import UIKit

class StackoverflowCommentController: UIViewController {
    ...
    func fetchComments() -> Void {
        ...
        let session: NSArray = APIGETSession("/stackoverflow/getlistcommentsforanswer/\(current_service)/?answer=\(String(current_stackoverflow_answer["answer_id"]!))")
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.navigationBar.title = "Comments" // TODO
        self.noAnswerLabel.text = "No comment found" // TODO
        self.noAnswerLabel.hidden = true
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = self.tableView.dequeueReusableCellWithIdentifier("stackoverflowCommentCell", forIndexPath: indexPath) as! StackoverflowAnswerCell
